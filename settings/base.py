...
TBANK_USE_SUCCESS_PAYMENT_REDIRECT_URL = env.as_bool("TBANK_USE_SUCCESS_PAYMENT_REDIRECT_URL", default=False)
TBANK_USE_FAIL_PAYMENT_REDIRECT_URL = env.as_bool("TBANK_USE_FAIL_PAYMENT_REDIRECT_URL", default=False)
